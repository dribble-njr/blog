...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,17),E={href:"https://git-scm.com/docs",target:"_blank",rel:"noopener noreferrer"},w=i(`<h2 id="测试" tabindex="-1"><a class="header-anchor" href="#测试" aria-hidden="true">#</a> 测试</h2><p>vscode 终端中输入 <code>sh depoly.sh</code>，报错：</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">sh</span> <span class="token builtin class-name">:</span> 无法将“sh”项识别为 cmdlet、函数、脚本文件或可运行程序的名称。
请检查名称的拼写，如果包括路径，请确保路径正确，然后再试一次。
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p>了解到 windows 上可以使用 git bash 执行 shell 脚本，但我可不想每次执行的时候都打开 git bash，当然得找如何在 vscode 中执行 shell 脚本的办法。</p><ol><li><p>首先得在 vscode 中安装 code runner，之前一直用它来调试力扣上的题，已经安装过了。</p></li><li><p>安装 git bash，这个不用说，安装 git 的时候就已经有了</p></li><li><p>配置 bash 环境，找到bash.exe的安装目录，将它的位置添加到系统的环境变量中。</p></li><li><p>配置 code runner：文件 -&gt; 首选项 -&gt; 设置 -&gt; 搜索 code runner</p><figure><img src="`+v+'" alt="配置 code runner" tabindex="0" loading="lazy"><figcaption>配置 code runner</figcaption></figure></li><li><p>打开终端，输入 <code>bash</code> 切换到 bash 环境，点击右上角的三角形即可运行。</p></li></ol><p>现在随便更新点内容，并执行 <code>deploy.sh</code> 脚本：</p><figure><img src="'+m+'" alt="成功" tabindex="0" loading="lazy"><figcaption>成功</figcaption></figure><p>再次访问 <code>http://xxx.xxx.xxx.xxx:端口号</code> 发现已经更新了。</p><h2 id="参考链接" tabindex="-1"><a class="header-anchor" href="#参考链接" aria-hidden="true">#</a> 参考链接</h2>',9),B={href:"http://chanwingwah.info/article/604eb2273c8ec67668f6fd41",target:"_blank",rel:"noopener noreferrer"},A={href:"https://www.imqianduan.com/git-svn/335.html",target:"_blank",rel:"noopener noreferrer"},W={href:"https://hjxlog.com/posts/20191130a1.html#7-%E9%85%8D%E7%BD%AENginx",target:"_blank",rel:"noopener noreferrer"},y={href:"https://www.cnblogs.com/yongdaimi/p/15247771.html",target:"_blank",rel:"noopener noreferrer"},C=n("blockquote",null,[n("p",null,"折腾了好久，因为实习的关系一直断断续续的研究，终于在这个周末抽了一天时间完成了。 现在就等域名备案了。")],-1);function I(D,L){const l=c("RouterLink"),a=c("ExternalLinkIcon");return d(),r("div",null,[h,n("p",null,[s("登录宝塔面板，可以参考"),e(l,{to:"/engineering/0003%E3%80%81%E9%85%8D%E7%BD%AE%E5%AE%9D%E5%A1%94%E9%9D%A2%E6%9D%BF.html"},{default:t(()=>[s("配置宝塔面板")]),_:1}),s("。点击左侧网站 -> 添加站点。")]),g,n("p",null,[s("新增之后，点击设置 -> 配置文件。这三项按自己的情况配置，在后面 "),e(l,{to:"/engineering/0004%E3%80%81%E8%87%AA%E5%8A%A8%E9%83%A8%E7%BD%B2.html#%E9%85%8D%E7%BD%AE-hooks"},{default:t(()=>[s("git hooks")]),_:1}),s(" 中会将 dist 文件推送到 "),k,s(" 配置项设置的文件夹下。")]),f,n("p",null,[s("在"),e(l,{to:"/engineering/0002%E3%80%81%E6%90%AD%E5%BB%BA%20git%20%E7%A7%81%E6%9C%8D.html"},{default:t(()=>[s("搭建 git 私服")]),_:1}),s("中已经搭建好了 git 私服，因此只需要初始化 "),_,s(" 仓库即可。")]),x,n("blockquote",null,[n("p",null,[s("了解更多 git 命令，可以查询"),n("a",E,[s("官方文档"),e(a)]),s("。")])]),w,n("p",null,[n("a",B,[s("只需三步， 部署Vuepress 并实现本地一行命令更新部署到服务器"),e(a)])]),n("p",null,[n("a",A,[s("使用git hooks(post-receive)实现简单的远程自动部署"),e(a)])]),n("p",null,[n("a",W,[s("将Hexo部署到阿里云轻量服务器（保姆级教程）"),e(a)])]),n("p",null,[n("a",y,[s("VSCode: Windows 下配置 VSCode运行shell"),e(a)])]),C])}const P=o(b,[["render",I],["__file","0004、自动部署.html.vue"]]);export{P as default};
