...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h2 id="盒模型-box-sizing" tabindex="-1"><a class="header-anchor" href="#盒模型-box-sizing" aria-hidden="true">#</a> 盒模型 <code>box-sizing</code></h2>`,21);function h(b,x){const d=t("RouterLink");return i(),s("div",null,[u,o("p",null,[e("见"),r(d,{to:"/frontend/basic/css/0005%E3%80%81%E5%B1%85%E4%B8%AD.html"},{default:c(()=>[e("居中")]),_:1}),e("。")])])}const p=a(l,[["render",h],["__file","0006、CSS3新属性.html.vue"]]);export{p as default};
