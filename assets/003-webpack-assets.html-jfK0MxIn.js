import{_ as c,r as i,o as t,c as d,a as s,d as n,b as e,w as o,e as l}from"./app-eZEY-ePh.js";const r={},u={href:"https://github.com/Stephen-wzw/webpack-demo",target:"_blank",rel:"noopener noreferrer"},k=l(`<h2 id="打包图片资源" tabindex="-1"><a class="header-anchor" href="#打包图片资源"><span>打包图片资源</span></a></h2><p>在项目中引入图片文件夹，并添加两张图片：</p><p><strong>project</strong></p><div class="language-diff line-numbers-mode" data-ext="diff" data-title="diff"><pre class="language-diff"><code><span class="token unchanged"><span class="token prefix unchanged"> </span><span class="token line"> webpack-demo
