...
</span></span></code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>其中 <code>source-map</code> 可以帮我们快速定位错误位置，在开发模式中，会默认设置 <code>devtool: &quot;source-map&quot;</code>。</p><p>此时重新打包后，在控制台就会出现错误的具体位置，能够快速帮我们解决 bug。</p><figure><img src="`+u+'" alt="with-source-map" tabindex="0" loading="lazy"><figcaption>with-source-map</figcaption></figure><h2 id="总结" tabindex="-1"><a class="header-anchor" href="#总结" aria-hidden="true">#</a> 总结</h2><p>webpack5 除了 loader 外，还有插件这一核心概念，他能执行范围更广的任务。</p><p>在这个案例中，我们首先介绍了如何清理 <code>dist</code> 文件夹；然后介绍如何打包 <code>index.html</code> 文件；接着是两个插件 <code>DefinePlugin</code> 和 <code>CopyWebpackPlugin</code> 的使用，它们可以帮助我们实现 Vue 打包中的一些功能；最后介绍了 webpack 的 <code>mode</code> 配置。</p>',57);function g(m,b){const a=p("ExternalLinkIcon");return i(),l("div",null,[n("blockquote",null,[n("p",null,[s("项目地址："),n("a",k,[s("https://github.com/Stephen-wzw/webpack-demo"),t(a)])])]),v])}const f=e(r,[["render",g],["__file","004-webpack-plugin.html.vue"]]);export{f as default};
